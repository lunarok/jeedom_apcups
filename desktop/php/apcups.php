        ...
        <div class="row">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label">{{Onduleur APC}}</label>
                    <div class="col-md-3">
                ...
                <form class="form-horizontal">
                    <fieldset>
                        ...
                        <div class="form-group">
                    		<label class="col-md-2 control-label">{{Adresse apcupsd}}</label>
                    		<div class="col-md-3">
                	...
                	<div class="form-group">
                    		<label class="col-md-2 control-label">{{Port apcupsd}}</label>
                    		<div class="col-md-3">
                	...
                	<div class="form-group">
                    		<label class="col-md-2 control-label">{{Puissance de l'onduleur}}</label>
                    		<div class="col-md-3">
